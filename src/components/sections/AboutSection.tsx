...
const AboutSection = () => {
  return (
    <section id="about" className="py-12 md:py-20 px-4 md:px-6 bg-black/50">
      <div className="max-w-5xl mx-auto">
        <div className="relative mb-8 md:mb-10 h-48 sm:h-56 md:h-72 lg:h-80 overflow-hidden rounded-2xl">
          <img
        ...
        <div className="glass-panel p-6 sm:p-8 md:p-10 lg:p-12 space-y-6 md:space-y-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-blink orange-gradient-text animate-on-scroll opacity-0 translate-y-4 transition-all duration-700 text-center font-medium leading-relaxed">
          ...
          <div className="space-y-6 animate-on-scroll opacity-0 translate-y-4 transition-all duration-700 delay-100">
            <p className="text-white/80 leading-relaxed text-center text-sm sm:text-base md:text-lg mb-6 md:mb-8 max-w-3xl mx-auto">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4 text-center">Our Core Services Include:</h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
              {serviceItems.map((service, index) => (
                <div key={index} className="glass-panel p-4 md:p-5 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
                  <h4 className="text-base md:text-lg font-medium mb-2 orange-gradient-text">{service.title}</h4>
