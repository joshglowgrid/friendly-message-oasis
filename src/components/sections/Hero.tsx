...
const Hero = () => {
  ...
  return <section ref={heroRef} onMouseMove={handleMouseMove} className="h-screen w-full flex flex-col items-center justify-center relative px-4 overflow-visible pointer-events-auto">
      {/* Floating logo */}
      <motion.div initial={{
      y: -20,
      opacity: 0
      ...
      stiffness: 100
        ...
        <Logo src="https://github.com/joshglowgrid/friendly-message-oasis/blob/main/glowgridmedia.png?raw=true" alt="GlowGrid Logo" url="https://glowgridmedia.com" />
        
        {/* Glow effect that follows mouse */}
        <div className="absolute -inset-10 opacity-20 blur-xl rounded-full pointer-events-none" style={{
      ...
      delay: 1.1
        ...
        <Button variant="gradient" size="lg" onClick={() => document.getElementById('contact')?.scrollIntoView({
        behavior: 'smooth'
      })} className="text-base px-8 py-6 h-auto">Get to know us!</Button>
      </motion.div>
      ...
      delay: 1.5,
      duration: 0.5
    }} className="absolute bottom-10 animate-bounce cursor-pointer arrow-indicator z-30" onClick={scrollToContent}>
